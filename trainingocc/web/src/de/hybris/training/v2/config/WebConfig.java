 ...
 */
package de.hybris.training.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import de.hybris.training.constants.YcommercewebservicesConstants;
import de.hybris.training.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "trainingocc.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "trainingocc.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "trainingocc.oauth2.tokenUrl";

	private static final String DESC = "trainingocc.v2.description";
	private static final String TITLE = "trainingocc.v2.title";
	private static final String VERSION = "trainingocc.v2.version";
	private static final String LICENSE = "trainingocc.v2.license";
	private static final String LICENSE_URL = "trainingocc.v2.license.url";
