...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "rest.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "rest.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "rest.oauth2.tokenUrl";

	private static final String DESC = "rest.v2.description";
	private static final String TITLE = "rest.v2.title";
	private static final String VERSION = "rest.v2.version";
	private static final String LICENSE = "rest.v2.license";
	private static final String LICENSE_URL = "rest.v2.license.url";
