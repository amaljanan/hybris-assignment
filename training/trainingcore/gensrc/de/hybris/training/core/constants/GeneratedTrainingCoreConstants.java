...
public class GeneratedTrainingCoreConstants
{
	...
	{
		public static final String DEALERTODRIVER = "DealerToDriver".intern();
		public static final String DEALERTOVEHICLE = "DealerToVehicle".intern();
		public static final String DRIVERTOVEHICLE = "DriverToVehicle".intern();
	}
