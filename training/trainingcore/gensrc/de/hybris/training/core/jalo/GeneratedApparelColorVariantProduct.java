 ...
 * --- Generated at 10-Oct-2021, 10:35:06 AM                    ---
 * ----------------------------------------------------------------
 *  
...
/**
 * Generated class for type {@link de.hybris.platform.variants.jalo.VariantProduct ApparelColorVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedApparelColorVariantProduct extends AccessoriesVehicleVariantProduct
{
	/** Qualifier of the <code>ApparelColorVariantProduct.color</code> attribute **/
	public static final String COLOR = "color";
	protected static final Map<String, AttributeMode> DEFAULT_INITIAL_ATTRIBUTES;
	static
	{
		final Map<String, AttributeMode> tmp = new HashMap<String, AttributeMode>(AccessoriesVehicleVariantProduct.DEFAULT_INITIAL_ATTRIBUTES);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ApparelColorVariantProduct.color</code> attribute.
	...
	public String getColor(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedApparelColorVariantProduct.getColor requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ApparelColorVariantProduct.color</code> attribute. 
	...
	public void setColor(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedApparelColorVariantProduct.setColor requires a session language", 0 );
		}
