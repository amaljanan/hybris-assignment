...
public class AccessoriesColorProvider implements FieldValueProvider, Serializable {
    ...
    private List<FieldValue> createFieldValue(AccessoriesColorVariantProductModel accessories, IndexedProperty indexedProperty) {
        ...
        final String colorAvailable = getColorAvailable(accessories);
        if (colorAvailable != null) {
            addFieldValues(fieldValues, indexedProperty, colorAvailable);
        }
        return fieldValues;
    }
    ...
    private String getColorAvailable(AccessoriesColorVariantProductModel accessories) {
